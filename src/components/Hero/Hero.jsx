...
function Hero() {
  ...
  return (
    <div className="container mt-2">
      <div
        className="overflow-hidden rounded-3xl min-h-[250px]
      sm:min-h-[350px] hero-bg-color flex justify-center
      items-center"
      >
                  ...
                  <div className="order-1 sm:order-2">
                    <div>
                      <img
                        ...
                        mx-auto drop-shadow-
                        [-8px_4px_6_px_rgba(0,0,0,.4)] relative z-40"
                      />
                    </div>
                  </div>
                </div>
